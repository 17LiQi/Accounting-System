...
export const TransactionTypesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        transactionTypesCreate: async (transactionType?: TransactionType, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(transactionType, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        transactionTypesUpdate: async (typeId: number, transactionType?: TransactionType, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'typeId' is not null or undefined
...
export const TransactionTypesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async transactionTypesCreate(transactionType?: TransactionType, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransactionType>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.transactionTypesCreate(transactionType, options);
         ...
         * @throws {RequiredError}
         */
        async transactionTypesList(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TransactionType>>> {
         ...
         * @throws {RequiredError}
         */
        async transactionTypesUpdate(typeId: number, transactionType?: TransactionType, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransactionType>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.transactionTypesUpdate(typeId, transactionType, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const TransactionTypesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        transactionTypesCreate(transactionType?: TransactionType, options?: RawAxiosRequestConfig): AxiosPromise<TransactionType> {
            return localVarFp.transactionTypesCreate(transactionType, options).then((request) => request(axios, basePath));
        },
        /**
         * 管理员删除指定交易类型，需确保无关联交易记录。
         * @summary 删除交易类型
         ...
         * @throws {RequiredError}
         */
        transactionTypesList(options?: RawAxiosRequestConfig): AxiosPromise<Array<TransactionType>> {
         ...
         * @throws {RequiredError}
         */
        transactionTypesUpdate(typeId: number, transactionType?: TransactionType, options?: RawAxiosRequestConfig): AxiosPromise<TransactionType> {
            return localVarFp.transactionTypesUpdate(typeId, transactionType, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class TransactionTypesApi extends BaseAPI {
     ...
     */
    public transactionTypesCreate(transactionType?: TransactionType, options?: RawAxiosRequestConfig) {
        return TransactionTypesApiFp(this.configuration).transactionTypesCreate(transactionType, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TransactionTypesApi
     */
    public transactionTypesUpdate(typeId: number, transactionType?: TransactionType, options?: RawAxiosRequestConfig) {
        return TransactionTypesApiFp(this.configuration).transactionTypesUpdate(typeId, transactionType, options).then((request) => request(this.axios, this.basePath));
    }
}
